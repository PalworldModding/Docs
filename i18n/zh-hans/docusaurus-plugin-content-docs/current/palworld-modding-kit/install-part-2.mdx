...
1、打开你在[上个教程](./install-part-1#finished)中下载Wwise的位置。如果成功安装，你应该可以看到以下文件夹结构。
...
:::note
译者提醒：你可能之前安装过Visual Studio 2019，且之后并未完全删除（比如这里）。此处建议：若在打开项目文件时出错，请尝试做这些操作。
:::
