...
- We are **not** going to cover Lua basics, like syntax or structures etc, in the main tutorials. We have a wonderful [Lua Basics](https://pwmodding.wiki/docs/Lua-Modding/LuaBasics) page for that. Please get yourself acquainted with Lua beforehand.
