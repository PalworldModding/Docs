...
If you cloned the [Palworld Modding Kit](https://github.com/localcc/PalworldModdingKit) repository using Git, you can easily update your local copy by running the following commands in your terminal:
...
Once it's done doing compiling, it should open Unreal Editor and you're now good to go!