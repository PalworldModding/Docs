...
[Download <FaDownload />](https://aka.ms/vs/17/release/vs_community.exe)

*7th January 2026 Update: Old download link was pointing to the 2026 version which replaced the 2022 version. VS 2026 does not work with Unreal Engine 5.1 so the link has been replaced with a direct link to the 2022 version from Microsoft's official download page which has been hidden away. - [Source](https://www.reddit.com/r/VisualStudio/comments/1p5oe3d/heres_the_microsoft_page_for_visual_studio_2022/)*
