...
:::
- Grab the latest [zDev Version](https://github.com/Okaetsu/RE-UE4SS/releases/tag/experimental-palworld) from the assets section
- Extract `ue4ss` and `dwmapi.dll` into your `Palworld/Pal/Binaries/Win64` folder or `Palworld/Pal/Binaries/WinGDK` folder if you have the Game Pass version of the game
