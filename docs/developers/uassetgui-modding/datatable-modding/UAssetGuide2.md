...
- Before heading into `Step 3. Add functionality to existing items` you need to follow the `install UE4SS to your game` , `Breakdown - Dumpers` part and also the `VSCode` section of `Add CXXHeaderDump to Workspace` found on [this page](/docs/developers/ue4ss-modding/lua-mods/lua-modding-tools)
...
- StaticItemId = the items static item ID > you can find them [here](https://paldeck.cc/items)
