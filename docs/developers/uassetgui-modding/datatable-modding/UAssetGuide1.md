...
First off, you will need to [install and setup FModel](/docs/developers/useful-tools/fmodel), follow the steps in the link and then meet me back here.
...
For that, you can use [Paldeck](https://paldeck.cc/items) to search for the item you need and then press the `Copy` icon on the item to copy its ID.
