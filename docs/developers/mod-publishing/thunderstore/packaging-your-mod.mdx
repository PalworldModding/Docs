...
Put your `main.lua` file which you wrote for your mod into the `mod/scripts` folder, for an example on how to write lua mods, you could look into the [Lua Modding](/docs/developers/ue4ss-modding/lua-mods/lua-intro) guide.
