...
<GitHubButton href="https://github.com/localcc/PalworldModdingKit/archive/HEAD.zip" data-color-scheme="no-preference: light; light: light; dark: dark;" data-icon="octicon-download" data-size="large" aria-label="Download localcc/PalworldModdingKit on GitHub">Download PDK Here</GitHubButton>
